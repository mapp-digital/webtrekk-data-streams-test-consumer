package com.webtrekk.datastreams.kafkaconsumer.logging;
...
public class TSVLogger {
    ...
    public void printMeta(String consumeTs,
                          Map<Integer, Integer> nRecordsPerPartition,
                          Map<Integer, Integer> sizeValuePerPartition,
                          Map<Integer, Long> lagMaxMsPerPartition,
                          long pollDurationMs,
                          long commitDurationMs) {
        if (enableTsvLos) {
            LOGGER_TSV_META.info(
                    consumeTs + "\t" +
                            nRecordsPerPartition + "\t" +
                            sizeValuePerPartition + "\t" +
                            lagMaxMsPerPartition + "\t" +
                            pollDurationMs + "\t" +
                            commitDurationMs
            );
        }
